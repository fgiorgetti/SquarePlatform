...
/**
 * Enemy that simply moves to left or right, until it gets blocked
 * by a blocking sprite, or by the beginning or end of the map. It can
 * also fall of the screen.
 *
