...
public abstract class Sprite {
	...
	// each sprite will have its own id once loaded
	...
	/**
	 * Validates against tiles whether player is allowed to move left
	 * @return
	 */
	...
	/**
	 * Validates against tiles whether player is allowed to move right
	 * @return
	 */
	...
	/**
	 * Validates against tiles whether player is allowed to move up
	 * @return
	 */
	...
	/**
	 * Validates against tiles whether player is allowed to move down
	 * @return
	 */
	...
	/**
	 * Sets new X position only if allowed to be there.
	 * @param newX
	 */
	...
	/**
	 * Sets new Y position only if allowed to move there
	 * @param newY
	 */
	...
	/**
	 * Returns true if this sprite has a collision with Player object
	 * @return
	 */
	...
	/**
	 * Adds a built Animation into the animations map
	 * @param animation
	 */
